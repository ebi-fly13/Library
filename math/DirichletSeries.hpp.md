...
data:
  ...
  bundledCode: "#line 2 \"math/DirichletSeries.hpp\"\n\r\n#include <functional>\r\n\
    ...
    \ {\r\n            ret.a = dirichlet_convolution_left_is_multiplicative_function(a,\
    \ rhs.a);\r\n        }\r\n        else if(rhs.is_multiplicative) {\r\n       \
    \     ret.a = dirichlet_convolution_left_is_multiplicative_function(rhs.a, a);\r\
  ...
  code: "#pragma once\r\n\r\n#include <functional>\r\n#include <numeric>\r\n#include\
    ...
    \ rhs.is_multiplicative) {\r\n            ret.a = dirichlet_convolution_multiplicative_function(a,\
    \ rhs.a);\r\n            ret.is_multiplicative = true;\r\n        }\r\n      \
    \  else if(is_multiplicative) {\r\n            ret.a = dirichlet_convolution_left_is_multiplicative_function(a,\
    \ rhs.a);\r\n        }\r\n        else if(rhs.is_multiplicative) {\r\n       \
    \     ret.a = dirichlet_convolution_left_is_multiplicative_function(rhs.a, a);\r\

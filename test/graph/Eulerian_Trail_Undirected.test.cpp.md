...
data:
  ...
  bundledCode: "#line 1 \"test/graph/Eulerian_Trail_Undirected.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/eulerian_trail_undirected\"\n\n#line\
    \ 2 \"graph/euler_trail.hpp\"\n\n#include <algorithm>\n#include <cassert>\n#include\
    \ <optional>\n#include <ranges>\n#include <utility>\n#include <vector>\n\n#line\
    ...
    \ dx = {0, 1, 0, -1, 1, -1, 1, -1};\n\n}  // namespace ebi\n#line 5 \"test/graph/Eulerian_Trail_Undirected.test.cpp\"\
    \n\nnamespace ebi {\n\nvoid main_() {\n    int n, m;\n    std::cin >> n >> m;\n\
  ...
  verifiedWith: []
documentation_of: test/graph/Eulerian_Trail_Undirected.test.cpp
layout: document
redirect_from:
- /verify/test/graph/Eulerian_Trail_Undirected.test.cpp
- /verify/test/graph/Eulerian_Trail_Undirected.test.cpp.html

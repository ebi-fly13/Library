...
data:
  ...
  bundledCode: "#line 1 \"test/Jump_on_Tree_HLD.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/jump_on_tree\"\
    ...
    \ sz, in, out, nxt, par, depth, rev;\n};\n\n}  // namespace ebi\n#line 7 \"test/Jump_on_Tree_HLD.test.cpp\"\
    \n\nint main() {\n    int n, q;\n    std::cin >> n >> q;\n    ebi::graph g(n);\n\
    \    for (int i = 0; i < n - 1; i++) {\n        int a, b;\n        std::cin >>\
  ...
  verifiedWith: []
documentation_of: test/Jump_on_Tree_HLD.test.cpp
layout: document
redirect_from:
- /verify/test/Jump_on_Tree_HLD.test.cpp
- /verify/test/Jump_on_Tree_HLD.test.cpp.html

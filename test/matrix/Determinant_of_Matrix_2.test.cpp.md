...
data:
  ...
  bundledCode: "#line 1 \"test/matrix/Determinant_of_Matrix_2.test.cpp\"\n#define\
    ...
    \ 1, -1, 1, -1};\n\n}  // namespace ebi\n#line 6 \"test/matrix/Determinant_of_Matrix_2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/matrix/Determinant_of_Matrix_2.test.cpp
layout: document
redirect_from:
- /verify/test/matrix/Determinant_of_Matrix_2.test.cpp
- /verify/test/matrix/Determinant_of_Matrix_2.test.cpp.html

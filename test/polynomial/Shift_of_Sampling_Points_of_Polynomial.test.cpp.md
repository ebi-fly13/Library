...
data:
  ...
  bundledCode: "#line 1 \"test/polynomial/Shift_of_Sampling_Points_of_Polynomial.test.cpp\"\
    \n#define PROBLEM \\\n    \"https://judge.yosupo.jp/problem/shift_of_sampling_points_of_polynomial\"\
    ...
    \n}  // namespace ebi\n#line 2 \"fps/shift_of_sampling_points_of_poly.hpp\"\n\n\
    #line 5 \"fps/shift_of_sampling_points_of_poly.hpp\"\n\n#line 2 \"math/binomial.hpp\"\
    ...
    \ 1, -1, 1, -1};\n\n}  // namespace ebi\n#line 8 \"test/polynomial/Shift_of_Sampling_Points_of_Polynomial.test.cpp\"\
    \n\nnamespace ebi {\n\nusing mint = modint998244353;\n\nvoid main_() {\n    int\
    \ n, m, c;\n    std::cin >> n >> m >> c;\n    std::vector<mint> f(n);\n    std::cin\
    \ >> f;\n    std::cout << shift_of_sampling_points_of_poly<mint, convolution>(f,\
    \ c, m)\n              << '\\n';\n}\n\n}  // namespace ebi\n\nint main() {\n \
    \   ebi::fast_io();\n    int t = 1;\n    // std::cin >> t;\n    while (t--) {\n\
    \        ebi::main_();\n    }\n    return 0;\n}\n"
  code: "#define PROBLEM \\\n    \"https://judge.yosupo.jp/problem/shift_of_sampling_points_of_polynomial\"\
...
layout: document
redirect_from:
- /verify/test/polynomial/Shift_of_Sampling_Points_of_Polynomial.test.cpp
- /verify/test/polynomial/Shift_of_Sampling_Points_of_Polynomial.test.cpp.html

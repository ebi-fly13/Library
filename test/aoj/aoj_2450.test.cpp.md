...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/aoj_2450.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2450\"\
    ...
    \ dx = {0, 1, 0, -1, 1, -1, 1, -1};\n\n}  // namespace ebi\n#line 4 \"test/aoj/aoj_2450.test.cpp\"\
    ...
    \ ebi\n#line 8 \"test/aoj/aoj_2450.test.cpp\"\n\nusing ebi::i64;\nusing ebi::LNF;\n\
    \nstruct S {\n    i64 sum;\n    i64 lhs;\n    i64 rhs;\n    i64 ans;\n    i64\
    \ sz;\n};\n\nusing F = i64;\nconst F ID = LNF;\n\nS op(S a, S b) {\n    if (a.sz\
    ...
    \  std::vector<S> vec(n);\n    for (int i = 0; i < n; i++) {\n        vec[hld.idx(i)]\
    \ = {w[i], w[i], w[i], w[i], 1};\n    }\n    ebi::lazy_segtree<S, op, e, F, mapping,\
    \ composition, id> seg1(vec);\n    ebi::lazy_segtree<S, op_rev, e, F, mapping,\

...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/aoj_2821.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2821\"\
    ...
    \ hs[1]);\n    return hs;\n}\n\n}  // namespace ebi\n#line 6 \"test/aoj/aoj_2821.test.cpp\"\
    \n\nnamespace ebi {\n\nvoid main_() {\n    int n1, m1;\n    std::cin >> n1 >>\
    \ m1;\n    Graph<int> g1(n1);\n    g1.read_graph(m1);\n    int n2;\n    std::cin\
  ...
  verifiedWith: []
documentation_of: test/aoj/aoj_2821.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/aoj_2821.test.cpp
- /verify/test/aoj/aoj_2821.test.cpp.html

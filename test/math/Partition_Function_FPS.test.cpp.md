...
data:
  ...
  bundledCode: "#line 1 \"test/math/Partition_Function_FPS.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/partition_function\"\n\n#include <iostream>\n\
    #include <vector>\n#include <numeric>\n\n#line 2 \"fps/fps.hpp\"\n\n#include <algorithm>\n\
    #include <cassert>\n#include <optional>\n#line 7 \"fps/fps.hpp\"\n\nnamespace\
    ...
    \ 4 \"fps/product_of_one_minus_xn.hpp\"\n\n#line 2 \"utility/modint_func.hpp\"\
    ...
    \ mod] * mint(q));\n    }\n    return dat[n];\n}\n\n}  // namespace ebi\n#line\
    \ 7 \"fps/product_of_one_minus_xn.hpp\"\n\nnamespace ebi {\n\n// prod (1 - x^a_i)\
    \ mod x^d\ntemplate <class mint, std::vector<mint> (*convolution)(\n         \
    ...
    \ ebi::convolution>;\n\nint main() {\n    int n;\n    std::cin >> n;\n    std::vector<int>\
    \ a(n);\n    std::iota(a.begin(), a.end(), 1);\n    FPS f = ebi::product_of_one_minus_xn<mint,\
    \ ebi::convolution>(a, n + 1);\n    f = f.inv();\n    for(int i = 0; i <= n; i++)\
    \ {\n        std::cout << f[i].val() << \" \\n\"[i == n];\n    }\n}\n"

...
data:
  ...
  bundledCode: "#line 1 \"test/yuki/yuki_1857.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1857\"\
    ...
    \    }\n    return fs.back();\n}\n\n}  // namespace ebi\n#line 2 \"fps/sum_of_rational_fps.hpp\"\
    \n\n#line 5 \"fps/sum_of_rational_fps.hpp\"\n\n#line 7 \"fps/sum_of_rational_fps.hpp\"\
    \n\nnamespace ebi {\n\ntemplate <Modint mint,\n          std::vector<mint> (*convolution)(const\
    \ std::vector<mint> &,\n                                           const std::vector<mint>\
    ...
    \ 1, -1, 1, -1};\n\n}  // namespace ebi\n#line 9 \"test/yuki/yuki_1857.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1857\"\n\n#include \"\
    ...
    \ 0, n) {\n        fs[i] = {1, p[i]};\n        gs[i] = {{0, 0, p[i] * p[i]}, {1,\
    \ p[i]}};\n    }\n    auto lhs = product_of_fps<mint, convolution>(fs);\n    auto\
    \ rhs = sum_of_rational_fps<mint, convolution>(gs);\n    auto f =\n        (FPS(lhs)\
    \ * (FPS(rhs.first) * FPS(rhs.second).inv(n + 2)).pre(n + 2))\n            .pre(n\
    \ + 2);\n    mint ans = 0;\n    mint fact = 1;\n    rep(i, 2, n + 2) {\n     \
    \   ans += f[i] * fact * i;\n        debug(f[i] * fact);\n        fact *= i;\n\
    \    }\n    std::cout << ans << '\\n';\n}\n\n}  // namespace ebi\n\nint main()\
    \ {\n    ebi::fast_io();\n    int t = 1;\n    // std::cin >> t;\n    while (t--)\
  ...
  verifiedWith: []
documentation_of: test/yuki/yuki_1857.test.cpp
layout: document
redirect_from:
- /verify/test/yuki/yuki_1857.test.cpp
- /verify/test/yuki/yuki_1857.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/yuki/yuki_2439.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2439\"\
    ...
    \ = c[i];\n        }\n        c = cs;\n    }\n    lazy_segtree<i64, op, e, i64,\
    \ mapping, composition, id> seg(c);\n    auto add_path = [&](int u, int v, i64\
    \ val) -> void {\n        auto f = [&](int l, int r) -> void {\n            if(l\
    \ < r) seg.apply(l, r, val);\n            else seg.apply(r, l, val);\n       \
    \ };\n        hld.path_noncommutative_query(u, v, false, f);\n    };\n    auto\
    \ path_min = [&](int u, int v) -> i64 {\n        i64 ret = e();\n        auto\
    \ f = [&](int l, int r) -> void {\n            if(l < r) ret = op(ret, seg.prod(l,\

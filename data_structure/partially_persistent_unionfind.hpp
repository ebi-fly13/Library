...
/*
    ...
    verify: https://atcoder.jp/contests/code-thanks-festival-2017-open/submissions/21131946
*/
...
public:
    ...
    int size(int t, int v) {
        v = find(t,v);
        return std::prev(std::upper_bound(data[v].begin(), data[v].end(), std::pair<int,int>(t,0)))->second;
    }

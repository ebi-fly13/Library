...
data:
  ...
  requiredBy: []
  timestamp: '2023-05-16 01:15:11+09:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith:
  - test/Exp_of_Set_Power_Series.test.cpp
documentation_of: algorithm/sps_exp.hpp
layout: document
redirect_from:
- /library/algorithm/sps_exp.hpp
- /library/algorithm/sps_exp.hpp.html
